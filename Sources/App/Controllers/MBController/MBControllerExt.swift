...
extension MBController {
    ...
    func createHashGen(appName: String, path: String, packageName: String, uiSettings: UISettings, metaLoc: String) {
    ...
    func createSerials(appName: String, path: String, packageName: String, uiSettings: UISettings, metaLoc: String) {
