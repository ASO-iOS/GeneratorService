...
struct RecorderMeta {
    ...
    static let fullDesc9 = "If you want to share your recordings with others, \(appName) makes it easy and convenient to do so. You can send files via email or upload them to cloud storage such as Google Drive or Dropbox. \(appName) also provides the ability to use external microphones to record audio, making it an ideal choice for professionals who want to record high-quality sound files. \(appName) also provides the ability to use external microphones to record sound, making it an ideal choice for professionals who want to record high-quality sound files."
    static let fullDesc10 = "\(appName) is a simple and efficient voice recorder application that will help you record high quality sound files in any situation. With its many features and user-friendly interface, \(appName) is the perfect tool for anyone who needs to record sound files on a daily basis. One of the main advantages of \(appName) is its ability to record sounds in the background, which allows you to continue working on your mobile device even if you are recording audio files. This feature also allows you to record phone calls or conversations in Skype or other apps."

    static let shortDesc1 = "Record your thoughts and ideas at any time with \(appName)!"
    static let shortDesc2 = "Never miss an important moment with \(appName)!"
    static let shortDesc3 = "Record your meetings and conversations with \(appName)!"
    static let shortDesc4 = "\(appName) is your personal assistant for recording audio!"
    static let shortDesc5 = "Create high-quality audio recordings in any situation with \(appName)!"
    static let shortDesc6 = "\(appName) is the best way to save the important moments in your life!"
    static let shortDesc7 = "Record voice notes and dictate text with \(appName)!"
    static let shortDesc8 = "Never forget important information with \(appName)!"
    static let shortDesc9 = "\(appName) is your trusted audio recording tool!"
    static let shortDesc10 = "Create your personal audio archive with \(appName)!"
