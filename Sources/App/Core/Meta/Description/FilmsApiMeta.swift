...
struct FilmsAPIMeta: MetaProviderProtocol {
    ...
    static func getFullDesc(appName: String) -> String {
        ...
        let fullDesc9 = "The \(appName) app has a user-friendly and intuitive interface that allows you to quickly and easily find the movie you want. You can select a movie by genre, actor, director, year and rating. The app provides a wide selection of movies grouped by genre, actor, director, year of release, and rating. You can select any genre you're interested in and the app will show you a list of movies that match your query. In addition, the app provides the ability to view movie trailers. This allows you to get an idea of the movie before you watch it and decide if it's right for you or not."
        let fullDesc10 = "One of the main features of the app is the ability to select a movie according to your mood. You can select the mood you are most in tune with, and the app will suggest a list of movies that are appropriate for that mood. For example, if you're in the mood for romance, the app will offer you a list of romantic movies. If you're in the mood for adventure, science fiction, or drama, the app will select movies that fit your desires. Another handy feature of the app is the ability to select a movie at random. If you don't know what to watch, you can use this feature to choose a movie you weren't expecting. This feature helps you avoid painful choices when searching for the perfect movie."
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc1 = "Never waste time searching for a movie with \(appName)!"
        let shortDesc2 = "Never miss a movie you'll love with \(appName)!"
        let shortDesc3 = "Never be uncertain about your movie choices with \(appName)!"
        let shortDesc4 = "Make your evening better with \(appName)!"
        let shortDesc5 = "Never be afraid to choose a movie with \(appName) again!"
        let shortDesc6 = "Feel like a film critic with the \(appName)!"
        let shortDesc7 = "Never miss a new movie with \(appName)!"
        let shortDesc8 = "Make your movie selection easier with the \(appName)!"
        let shortDesc9 = "Never stop at one movie with \(appName)!"
        let shortDesc10 = "Learn more about the movies you love with the \(appName)!"
