...
struct WaterTrackerMeta: MetaProviderProtocol {
    ...
    static func getFullDesc(appName: String) -> String {
        ...
        let fullDesc9 = "\(appName) is a mobile application designed specifically for those who care about their health and want to maintain an optimal level of hydration. It helps you monitor how much water you drink throughout the day, set goals, and get reminders to drink. The app also offers personalized drinking recommendations based on your age, gender, physical activity and climate conditions. Drinking enough water is of utmost importance to our bodies. Water helps keep organs and systems functioning properly, moisturizes the skin, improves digestion and metabolism, and helps flush toxins out of the body. However, in today's world, we often forget to drink enough water and are at risk of dehydration."

        let fullDesc10 = "With the \(appName) app, you can easily keep track of your drinking regimen and remember to drink. You will be able to monitor the amount of water you drink throughout the day and set goals for yourself. The app will send you reminders to drink so that you are always hydrated. One of the key features of \(appName) is the ability to record not only water, but also other drinks such as tea, coffee, juices and others. You will be able to see the total amount of liquids consumed in a day and analyze your drinking habits. This will help you better understand how hydrated you are and make adjustments to your drinking habits when necessary."

        let fullDesc11 = "\(appName) also offers the ability to track your achievements and progress in staying hydrated. You'll be able to see statistics on how much water you drink over different periods of time, set goals and track your progress. This will help you get motivated and maintain proper drinking habits over the long term. The \(appName) app has a simple and intuitive interface that will allow you to easily manage your drinking data. You will be able to quickly and conveniently add information about the fluids you drink, view statistics and customize drinking reminders according to your preferences."

        let fullDesc12 = "\(appName) is more than just an app, it is your personal trainer and assistant for maintaining optimal water levels in your body. It will help you take care of your health with ease and comfort, monitor your drinking and stay in shape. Improve your life with proper hydration and become energetic and healthy through proper drinking. Don't forget about your well-being and reach new heights with \(appName). This app will be an indispensable tool for those who want to take care of themselves and their health. Install \(appName) right now and start tracking your drinking today!"

        let fullDesc13 = "\(appName) is a mobile application designed specifically for those who care about their health and want to maintain an optimal level of hydration. It helps you monitor how much water you drink throughout the day, set goals, and get reminders to drink. The app also offers personalized drinking recommendations based on your age, gender, physical activity and climate conditions. Drinking enough water is of utmost importance to our bodies. Water helps keep organs and systems functioning properly, moisturizes the skin, improves digestion and metabolism, and helps flush toxins out of the body. However, in today's world, we often forget to drink enough water and are at risk of dehydration."

        let fullDesc14 = "With the \(appName) app, you can easily keep track of your drinking regimen and remember to drink. You will be able to monitor the amount of water you drink throughout the day and set goals for yourself. The app will send you reminders to drink so that you are always hydrated. One of the key features of \(appName) is the ability to record not only water, but also other drinks such as tea, coffee, juices and others. You will be able to see the total amount of liquids consumed in a day and analyze your drinking habits. This will help you better understand how hydrated you are and make adjustments to your drinking habits when necessary."

        let fullDesc15 = "\(appName) also offers the ability to track your achievements and progress in staying hydrated. You'll be able to see statistics on how much water you drink over different periods of time, set goals and track your progress. This will help you get motivated and maintain proper drinking habits over the long term. The \(appName) app has a simple and intuitive interface that will allow you to easily manage your drinking data. You will be able to quickly and conveniently add information about the fluids you drink, view statistics and customize drinking reminders according to your preferences."

        let fullDesc16 = "\(appName) is more than just an app, it is your personal trainer and assistant for maintaining optimal water levels in your body. It will help you take care of your health with ease and comfort, monitor your drinking and stay in shape. Improve your life with proper hydration and become energetic and healthy through proper drinking. Don't forget about your well-being and reach new heights with \(appName). This app will be an indispensable tool for those who want to take care of themselves and their health. Install \(appName) right now and start tracking your drinking today!"

        let fullDesc17 = "\(appName) is a mobile application designed specifically for those who care about their health and want to maintain an optimal level of hydration. It helps you monitor how much water you drink throughout the day, set goals, and get reminders to drink. The app also offers personalized drinking recommendations based on your age, gender, physical activity and climate conditions. Drinking enough water is of utmost importance to our bodies. Water helps keep organs and systems functioning properly, moisturizes the skin, improves digestion and metabolism, and helps flush toxins out of the body. However, in today's world, we often forget to drink enough water and are at risk of dehydration."

        let fullDesc18 = "With the \(appName) app, you can easily keep track of your drinking regimen and remember to drink. You will be able to monitor the amount of water you drink throughout the day and set goals for yourself. The app will send you reminders to drink so that you are always hydrated. One of the key features of \(appName) is the ability to record not only water, but also other drinks such as tea, coffee, juices and others. You will be able to see the total amount of liquids consumed in a day and analyze your drinking habits. This will help you better understand how hydrated you are and make adjustments to your drinking habits when necessary."

        let fullDesc19 = "\(appName) also offers the ability to track your achievements and progress in staying hydrated. You'll be able to see statistics on how much water you drink over different periods of time, set goals and track your progress. This will help you get motivated and maintain proper drinking habits over the long term. The \(appName) app has a simple and intuitive interface that will allow you to easily manage your drinking data. You will be able to quickly and conveniently add information about the fluids you drink, view statistics and customize drinking reminders according to your preferences."

        let fullDesc20 = "\(appName) is more than just an app, it is your personal trainer and assistant for maintaining optimal water levels in your body. It will help you take care of your health with ease and comfort, monitor your drinking and stay in shape. Improve your life with proper hydration and become energetic and healthy through proper drinking. Don't forget about your well-being and reach new heights with \(appName). This app will be an indispensable tool for those who want to take care of themselves and their health. Install \(appName) right now and start tracking your drinking today!"
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc1 = "\(appName) - your personal assistant in maintaining hydration!"

        let shortDesc2 = "\(appName) - monitor your health with ease!"

        let shortDesc3 = "\(appName) - take care of yourself by monitoring your drinking!"

        let shortDesc4 = "\(appName) - keep your body in perfect shape with proper hydration!"

        let shortDesc5 = "\(appName) - forget dehydration, watch your drinking regimes!"

        let shortDesc6 = "\(appName) - improve your health with proper hydration!"

        let shortDesc7 = "\(appName) - stay fit by monitoring your drinking!"

        let shortDesc8 = "\(appName) - reach new heights with proper hydration!"

        let shortDesc9 = "\(appName) - your personal trainer to maintain optimal water levels in your body!"

        let shortDesc10 = "\(appName) - take care of your health with ease and comfort!"

        let shortDesc11 = "\(appName) - keep track of your drinking and stay in shape!"

        let shortDesc12 = "\(appName) - improve your life with proper hydration!"

        let shortDesc13 = "\(appName) - be energetic and healthy with proper drinking!"

        let shortDesc14 = "\(appName) - your personal assistant to achieve hydration!"

        let shortDesc15 = "\(appName) - control your drinking and stay fit!"

        let shortDesc16 = "\(appName) - reach new heights with proper hydration!"

        let shortDesc17 = "\(appName) - take care of your health with ease and comfort!"

        let shortDesc18 = "\(appName) - keep track of your drinking and stay fit!"

        let shortDesc19 = "\(appName) - improve your life with proper hydration!"

        let shortDesc20 = "\(appName) - be energetic and healthy with proper drinking!"
