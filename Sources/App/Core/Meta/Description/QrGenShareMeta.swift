...
struct QrGenShareMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        ...
        let shortDesc21 =  "\(appName) - Create and send!"
