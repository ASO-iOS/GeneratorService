...
struct DotCrossGameMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc1 = "\(appName) - play and enjoy!"

        let shortDesc2 = "\(appName) - exciting entertainment on your mobile!"

        let shortDesc3 = "\(appName) - you won't get bored with us!"

        let shortDesc4 = "\(appName) - play anytime and anywhere!"

        let shortDesc5 = "\(appName) - your new gaming partner!"

        let shortDesc6 = "\(appName) - an exciting game for everyone!"

        let shortDesc7 = "\(appName) - develop your logical skills!"

        let shortDesc8 = "\(appName) - immerse yourself in the world of puzzles!"

        let shortDesc9 = "\(appName) - keep your brain in shape!"

        let shortDesc10 = "\(appName) - play and compete with your friends!"

        let shortDesc11 = "\(appName) - relax and enjoy the game!"

        let shortDesc12 = "\(appName) - great fun alone or with friends!"

        let shortDesc13 = "\(appName) - play and have fun without limits!"

        let shortDesc14 = "\(appName) - test your logic and wit!"

        let shortDesc15 = "\(appName) - exciting puzzles in one application!"

        let shortDesc16 = "\(appName) - forget about boring moments with us!"

        let shortDesc17 = "\(appName) - play and train your brain at the same time!"

        let shortDesc18 = "\(appName) - an application that will not leave you indifferent!"

        let shortDesc19 = "\(appName) - fun, exciting, thrilling!"

        let shortDesc20 = "\(appName) - play and immerse yourself in the world of puzzles!"
