...
struct WordWiseMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        ...
        let shortDesc21 =  "\(appName): Interpretation of words."
