...
struct TorchMeta: MetaProviderProtocol {
    ...
    static let fullDesc9 = "If you're looking for a simple and reliable app to use as a flashlight, \(appName) is just what you need. It is available for download on most mobile devices and is compatible with a variety of operating systems. It also has no ads or annoying notifications, making it even more convenient to use. No matter where you are or what task you are performing, \(appName) will help you quickly and easily light your way and complete any task that requires light. Whether you're searching for keys in a dark corner, camping at night, or walking around town at night, the \(appName) is your trusted and handy helper."
    static let fullDesc10 = "It's a reliable and handy flashlight that will be indispensable in any situation where you need a light source. \(appName) also has additional features that make it even more convenient and practical. For example, the app allows you to adjust the brightness of the light, which saves the battery life of your device. In addition, \(appName) is very convenient and practical because it doesn't take up much space on your device and you can use it anytime, anywhere."

    static let shortDesc1 = "Light up your life with \(appName)!"
    static let shortDesc2 = "\(appName) is your reliable and bright flashlight!"
    static let shortDesc3 = "Simple and practical light source in your pocket!"
    static let shortDesc4 = "Turn your phone into a powerful flashlight with a \(appName)!"
    static let shortDesc5 = "\(appName), the reliable helper in the dark!"
    static let shortDesc6 = "\(appName) is a fast, convenient way to light your way!"
    static let shortDesc7 = "\(appName) - your reliable and bright light in the dark!"
    static let shortDesc8 = "\(appName), the ultimate flashlight for any situation!"
    static let shortDesc9 = "\(appName) - never be left in the dark!"
    static let shortDesc10 = "\(appName) - your reliable and bright source of light in any situation!"
