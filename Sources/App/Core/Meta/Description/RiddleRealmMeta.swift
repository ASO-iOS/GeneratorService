...
struct RiddleRealmMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        ...
        let shortDesc21 =  "\(appName): Riddles and Answers."
