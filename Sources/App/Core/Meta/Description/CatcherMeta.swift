...
struct CatcherMeta: MetaProviderProtocol {
    ...
    static let fullDesc9 = "The game has a simple and clear interface, making it accessible to all age groups. You can play \(appName) anytime and anywhere thanks to its mobile version. Just open the app on your mobile device and start playing immediately. \(appName) is not only a great entertainment game, but also a tool to develop your reflexes and movement coordination. It offers you the opportunity to test your skills and become a real master in catching falling objects. Download \(appName) now and start your exciting journey into the world of quick reactions and dexterity!"
    
    static let fullDesc10 = "\(appName) is an exciting game that allows you to test your reaction and agility skills. In this exciting game, your task will be to catch all the falling objects to score maximum points. You start the game with simple objects that fall from the top of the screen. Your task is to move a special mesh object left and right to catch these falling objects. The more objects you catch, the more points you get."
    
    static let fullDesc11 = "However, the game is not as easy as it may seem at first glance. Falling objects will move faster and faster, so you will have to be very fast and accurate to catch them in time. In addition, some objects can have different shapes and sizes, which adds to the complexity of the game. \(appName) offers several levels of difficulty so that each player can choose the right one for himself. You can start with the easiest level and gradually increase the difficulty as your skill and reaction improves. It's a great way to hone your skills and get better and better at the game."
    
    static let fullDesc12 = "But \(appName) is not only an entertaining game, it also helps to develop your reflexes and hand-eye coordination. Constantly moving the mesh object to catch falling objects requires you to be quick to react and accurate. You will train your brain and hands, improving your ability to react quickly to a changing situation. In addition, \(appName) offers the possibility to compete with other players. You can compare your results with those of other players and try to top the leaderboard. This adds an element of competition and motivates you to strive for better results."
    
    static let fullDesc13 = "The game has a simple and clear interface, making it accessible to all age groups. You can play \(appName) anytime and anywhere thanks to its mobile version. Just open the app on your mobile device and start playing immediately. \(appName) is not only a great entertainment game, but also a tool to develop your reflexes and movement coordination. It offers you the opportunity to test your skills and become a real master in catching falling objects. Download \(appName) now and start your exciting journey into the world of quick reactions and dexterity!"
    
    static let fullDesc14 = "\(appName) is an exciting game that allows you to test your reaction and agility skills. In this exciting game, your task will be to catch all the falling objects to score maximum points. You start the game with simple objects that fall from the top of the screen. Your task is to move a special mesh object left and right to catch these falling objects. The more objects you catch, the more points you get."
    
    static let fullDesc15 = "However, the game is not as easy as it may seem at first glance. Falling objects will move faster and faster, so you will have to be very fast and accurate to catch them in time. In addition, some objects can have different shapes and sizes, which adds to the complexity of the game. \(appName) offers several levels of difficulty so that each player can choose the right one for himself. You can start with the easiest level and gradually increase the difficulty as your skill and reaction improves. It's a great way to hone your skills and get better and better at the game."
    
    static let fullDesc16 = "But \(appName) is not only an entertaining game, it also helps to develop your reflexes and hand-eye coordination. Constantly moving the mesh object to catch falling objects requires you to be quick to react and accurate. You will train your brain and hands, improving your ability to react quickly to a changing situation. In addition, \(appName) offers the possibility to compete with other players. You can compare your results with those of other players and try to top the leaderboard. This adds an element of competition and motivates you to strive for better results."
    
    static let fullDesc17 = "The game has a simple and clear interface, making it accessible to all age groups. You can play \(appName) anytime and anywhere thanks to its mobile version. Just open the app on your mobile device and start playing immediately. \(appName) is not only a great entertainment game, but also a tool to develop your reflexes and movement coordination. It offers you the opportunity to test your skills and become a real master in catching falling objects. Download \(appName) now and start your exciting journey into the world of quick reactions and dexterity!"
    
    static let fullDesc18 = "\(appName) is an exciting game that allows you to test your reaction and agility skills. In this exciting game, your task will be to catch all the falling objects to score maximum points. You start the game with simple objects that fall from the top of the screen. Your task is to move a special mesh object left and right to catch these falling objects. The more objects you catch, the more points you get."
    
    static let fullDesc19 = "However, the game is not as easy as it may seem at first glance. Falling objects will move faster and faster, so you will have to be very fast and accurate to catch them in time. In addition, some objects can have different shapes and sizes, which adds to the complexity of the game. \(appName) offers several levels of difficulty so that each player can choose the right one for himself. You can start with the easiest level and gradually increase the difficulty as your skill and reaction improves. It's a great way to hone your skills and get better and better at the game."
    
    static let fullDesc20 = "But \(appName) is not only an entertaining game, it also helps to develop your reflexes and hand-eye coordination. Constantly moving the mesh object to catch falling objects requires you to be quick to react and accurate. You will train your brain and hands, improving your ability to react quickly to a changing situation. In addition, \(appName) offers the possibility to compete with other players. You can compare your results with those of other players and try to top the leaderboard. This adds an element of competition and motivates you to strive for better results!"
    
    
    
    static let shortDesc1 = "Catch everything that falls from the \(appName)!"
    
    static let shortDesc2 = "Improve your reflexes with \(appName)!"
    
    static let shortDesc3 = "Hone your skills with \(appName)!"
    
    static let shortDesc4 = "Test your reaction time with \(appName)!"
    
    static let shortDesc5 = " Become a master catcher with \(appName)!"
    
    static let shortDesc6 = "Catch everything you can with \(appName)!"
    
    static let shortDesc7 = "Develop your reflexes with \(appName)!"
    
    static let shortDesc8 = "Capture the moment with \(appName)!"
    
    static let shortDesc9 = "Challenge your reflexes with \(appName)!"
    
    static let shortDesc10 = "Become the best catcher with \(appName)!"
    
    static let shortDesc11 = "Catch everything that falls and win the \(appName)!"
    
    static let shortDesc12 = "Hone your catching skills with \(appName)!"
    
    static let shortDesc13 = "Challenge your reflexes with \(appName)!"
    
    static let shortDesc14 = "Become a true professional catcher with \(appName)!"
    
    static let shortDesc15 = "Catch everything that falls and become a champion in the \(appName)!"
    
    static let shortDesc16 = "Improve your reflexes and reach new heights with \(appName)!"
    
    static let shortDesc17 = "Test your reaction speed and become the best player in \(appName)!"
    
    static let shortDesc18 = "Become a master at catching falling objects with \(appName)!"
    
    static let shortDesc19 = "Challenge your reflexes and prove your skill in \(appName)!"
    
    static let shortDesc20 = "Catch everything that falls and dominate the world of \(appName)!"
