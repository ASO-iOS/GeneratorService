...
struct ToDoListMeta: MetaProviderProtocol {
    ...
    static func getFullDesc(appName: String) -> String {
        ...
        let fullDesc9 = "In the \(appName) app, you can create multiple task lists for different purposes, such as work, personal business, or study. You can easily switch between task lists depending on your current task. Overall, \(appName) is a simple and easy-to-use app to help you organize your day and achieve your goals. You can use it for both personal matters and work, and it will be a reliable assistant in any situation."
        let fullDesc10 = "When you have a lot of things to do, it can be hard to keep them all in your head. In this case, the \(appName) app can be your reliable assistant. It is an app that helps you manage your tasks and plan your day. In the \(appName) app, you can create multiple task lists for different purposes, such as work, personal business or study. You can easily switch between task lists depending on your current task."
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc1 = "Never forget an important case with the \(appName)!"
        let shortDesc2 = "Manage your time with \(appName)!"
        let shortDesc3 = "\(appName) - your reliable assistant in organizing tasks!"
        let shortDesc4 = "Organize your life with the \(appName)!"
        let shortDesc5 = "Complete all your tasks on time with the \(appName)!"
        let shortDesc6 = "\(appName) is the best way to get your day organized!"
        let shortDesc7 = "\(appName) is an app that will help you achieve your goals!"
        let shortDesc8 = "Never miss an important thing with \(appName)!"
        let shortDesc9 = "\(appName) is an easy and convenient way to manage your tasks!"
        let shortDesc10 = "\(appName) - your personal organizer in your phone!"
