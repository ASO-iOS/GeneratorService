...
struct PassGeneratorMeta: MetaProviderProtocol {
    ...
    static func getFullDesc(appName: String) -> String {
        let fullDesc1 = "\(appName) is a mobile application that offers the user a unique and reliable way to generate passwords. Nowadays, with more and more information being stored and transmitted over the Internet, security has become an important issue. One of the main aspects of security is the use of complex and unique passwords for all accounts. However, many people find it difficult to come up with passwords that are both secure and easy to remember. This is where \(appName) comes to the rescue. It is an intuitive and easy-to-use application that generates unique passwords for various accounts and services"
        let fullDesc2 = "The main function of \(appName) is the generation of passwords. The application prompts the user to select a password length and specify which characters should be included in the password (numbers, upper and lower case letters, special characters). After that, \(appName) creates a random password that matches the specified parameters. Thus, the user can be sure that his or her password will be safe and tamper-proof. In addition, \(appName) offers an auto-complete password function. The application integrates with the user's browser and automatically fills in the password fields on various sites and services. This simplifies the process of logging into accounts and prevents mistakes in password entry"
        let fullDesc3 = "One of the features of \(appName) is the ability to save the generated passwords in a secure storage. A user can create an account in the application and save all of their passwords in an encrypted form. This not only allows you to access your passwords at any time and from any device, but also ensures their security. All passwords are encrypted and only the user has access to them. Another useful feature of \(appName) is a password security check. The app analyzes the generated passwords and assesses their security. It warns the user if the password is too simple or easily hacked. This helps the user to create passwords that are as secure as possible from intruders"
        let fullDesc4 = "\(appName) is an indispensable tool for everyone who values the security of their data and wants to have strong passwords for their accounts. The application offers an easy and convenient way to generate passwords, save them in a secure vault and automatically fill them in on various sites. Be sure your data is secure with \(appName)! However, many people face the problem of coming up with passwords that are both secure and easy to remember. This is where \(appName) comes to the rescue. It is an intuitive and easy-to-use application that generates unique passwords for various accounts and services"
        let fullDesc5 = "\(appName) is a mobile application that offers users a unique and reliable way to generate passwords. Nowadays, with more and more information being stored and transmitted over the Internet, security has become an important issue. One of the main aspects of security is the use of complex and unique passwords for all accounts. In addition, \(appName) offers an auto-complete password feature. The application integrates with the user's browser and automatically fills in password fields on various sites and services. This simplifies the process of logging into accounts and prevents password errors"
        let fullDesc6 = "One of the features of \(appName) is the ability to save the generated passwords in a secure storage. A user can create an account in the application and save all of their passwords in an encrypted form. This allows you not only to access your passwords at any time and from any device, but also ensures their security. All passwords are encrypted and only the user has access to them. In addition, \(appName) offers an auto-complete password function. The application integrates with the user's browser and automatically fills out password fields on various sites and services. This simplifies the process of logging into accounts and prevents mistakes in password entry."
        let fullDesc7 = "\(appName) is an indispensable tool for everyone who values the security of their data and wants to have strong passwords for their accounts. The application offers an easy and convenient way to generate passwords, save them in a secure vault and automatically fill them in on various sites. Be sure your data is safe with \(appName)! Another useful function of \(appName) is checking the security of your passwords. The app analyzes the generated passwords and evaluates their security. It warns the user if a password is too simple or too easy to crack. This helps the user to create passwords that are as safe as possible from intruders."
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc1 = "The password generator is your trusted companion in the world of digital security!"
        let shortDesc2 = "Protect your data with \(appName), your own personal password generator!"
        let shortDesc3 = "\(appName) - create impenetrable passwords with a single click!"
        let shortDesc4 = "No more problems with passwords - \(appName) is always with you!"
        let shortDesc5 = "Make your life easy with \(appName)!"
        let shortDesc6 = "Protect your privacy with \(appName), the reliable password generator!"
        let shortDesc7 = "\(appName) is an easy way to create secure passwords for all your accounts!"
        let shortDesc8 = "Your security is in your hands with \(appName), your personal password generator!"
        let shortDesc9 = "Secure and handy in one app - \(appName) for your phone!"
        let shortDesc10 = "Passwords are not a problem anymore - \(appName) will help you to create and remember them all!"
