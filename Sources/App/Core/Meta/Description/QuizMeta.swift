...
struct QuizMeta {
    ...
    static let fullDesc9 = "\(appName) is an app that will help you expand your knowledge and learn a lot about the world around you. It offers a huge selection of quizzes on various topics, from history to sports to movies. You can choose any topic that interests you and test your knowledge in that area. You can take tests on a particular topic and learn everything about it. This will help you become a professional in your field and give you answers to any questions."
    static let fullDesc10 = "\(appName) is not only an opportunity to test your knowledge, but also a great way to develop your intelligence. You will be forced to think and analyze information in order to answer test questions. This will help you improve your memory and logical thinking. \(appName) is an app that will help you expand your horizons and learn a lot about the world around you. You can play it anytime and anywhere, and you can choose test topics of your choice. Take the tests and become a true expert with \(appName)!"

    static let shortDesc1 = "Develop your intelligence with \(appName)!"
    static let shortDesc2 = "\(appName) is an exciting way to learn new things!"
    static let shortDesc3 = " Learn more about the world around you with the \(appName)!"
    static let shortDesc4 = "The \(appName) - test your knowledge and learn something new!"
    static let shortDesc5 = "Take quizzes and become a real expert with the \(appName)!"
    static let shortDesc6 = "\(appName) - A game to help you get smarter!"
    static let shortDesc7 = "Learn something new every day with Simple Quize!"
    static let shortDesc8 = "\(appName) is the best way to learn interesting facts!"
    static let shortDesc9 = "Test your knowledge in different areas with \(appName)!"
    static let shortDesc10 = "\(appName) - discover new horizons of knowledge!"
