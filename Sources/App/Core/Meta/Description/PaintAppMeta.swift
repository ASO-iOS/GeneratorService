...
struct PaintAppMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc1 = "\(appName) the world with \(appName), the best drawing app on your phone!"
        let shortDesc2 = "Bring your creative ideas to life with \(appName), the easy and convenient drawing app!"
        let shortDesc3 = "Masterpieces on your phone with \(appName), the app that's always at your fingertips!"
        let shortDesc4 = "Color up your routine with \(appName), an app that lets you draw anytime, anywhere!"
        let shortDesc5 = "\(appName) is your pocket artist, always ready to capture your ideas!"
        let shortDesc6 = "Breathe life into your drawings with \(appName), an app that offers many tools and effects!"
        let shortDesc7 = "Unleash your creativity with \(appName), an app that makes drawing easy and fun!"
        let shortDesc8 = "\(appName) is your magic paintbrush that lets you create works of art on your phone!"
        let shortDesc9 = "Draw your dreams with \(appName), an app that helps you bring any idea to life on your phone screen!"
        let shortDesc10 = "\(appName) is your perfect companion for creativity that fits in your pocket!"
