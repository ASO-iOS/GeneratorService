...
struct LanguageIdentifireMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        ...
        let shortDesc21 =  "\(appName): Identify the language."
