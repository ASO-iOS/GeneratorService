...
struct NotesMeta: MetaProviderProtocol {
    ...
    static let fullDesc24 = "\(appName) can be used for both personal and professional purposes. One of the main features of Note is its simple and intuitive interface. You can easily get used to its functionality even if you have had no previous experience with similar applications. All the controls are located on one screen, which makes working with the application as convenient and efficient as possible."
    static let fullDesc25 = "\(appName) can be used to create notes, reminders, emails, messages, to-do lists and shopping. The application also has a number of additional features that make it even more convenient and functional. You can easily customize the color of your notes to quickly and easily distinguish them. In addition, the app supports multiple languages, allowing you to choose the best option for your particular task."
    static let fullDesc26 = "\(appName) is an application that will be an indispensable assistant in organizing your life. With it you can create notes on any topic, from shopping to important business meetings. \(appName) is a handy notebook that allows you to quickly and easily write down everything you need."
    static let fullDesc27 = "\(appName) can be used for both personal and professional purposes. It can be used to create notes, reminders, emails, messages, to-do lists and shopping. The application allows you to create notes quickly and easily, making it an indispensable tool for various tasks."
    static let fullDesc28 = "If you are looking for an easy and convenient way to organize your life and not to forget important moments, \(appName) is a great choice for you. It provides fast and accurate note taking, a high level of security and a simple interface, making it an ideal choice for users of all levels. Whether you're a professional developer or just want to organize your life, \(appName) will help you achieve that goal."
    static let fullDesc29 = "\(appName) is a simple and easy-to-use note taking application that will help you organize your life and not forget important moments. It provides a high level of security, a simple interface and a number of additional features that make it an ideal choice for users of all levels. If you are looking for a reliable tool to organize your life, \(appName) is a great choice for you."
    static let fullDesc30 = "\(appName) is a handy notebook that allows you to quickly and easily write down everything you need. One of the main features of \(appName) is its simple and intuitive interface. You can easily get the hang of its functionality, even if you have had no previous experience with such applications. All the controls are located on one screen, which makes working with the application as convenient and efficient as possible."
    
    static let shortDesc1 = "Write quickly and efficiently with \(appName)!!"

    static let shortDesc2 = "Improve your productivity with \(appName)!!"

    static let shortDesc3 = "\(appName) is your quick writing assistant!"

    static let shortDesc4 = "Write faster and easier with \(appName)!"

    static let shortDesc5 = "\(appName) is an innovative application for fast writing!"

    static let shortDesc6 = "Save time with \(appName)!"

    static let shortDesc7 = "\(appName) is your personal writing assistant!"

    static let shortDesc8 = "Increase your efficiency with \(appName)!"

    static let shortDesc9 = "Fast writing is made possible with \(appName)!"

    static let shortDesc10 = "\(appName) - write quickly and easily on mobile devices!"

    static let shortDesc11 = "Save time and effort with \(appName)!"

    static let shortDesc12 = "\(appName) makes typing fast and easy!"

    static let shortDesc13 = "\(appName) is your trusted texting assistant!"

    static let shortDesc14 = "Improve your writing skills with \(appName)!"

    static let shortDesc15 = "Faster, easier, more efficient - with \(appName)!"

    static let shortDesc16 = "\(appName) is an intuitive app for fast writing!"

    static let shortDesc17 = "Quick and accurate typing with \(appName)!"

    static let shortDesc18 = "Increase your productivity with \(appName)!"

    static let shortDesc19 = "\(appName) is your secret weapon in writing!"

    static let shortDesc20 = "Faster, better, more efficient - with \(appName)!"
    static let shortDesc21 = "Never forget an important thing with \(appName)!"
    static let shortDesc22 = "Organize your life with \(appName)!"
    static let shortDesc23 = "All the important moments in one place - in \(appName)!"
    static let shortDesc24 = "Write down everything you need in \(appName)!"
    static let shortDesc25 = "\(appName) is your personal assistant for organizing your life!"
    static let shortDesc26 = "Easily and conveniently create notes with \(appName)!"
    static let shortDesc27 = "\(appName) is a reliable tool for organizing your life!"
    static let shortDesc28 = "Never miss an important thing with \(appName)!"
    static let shortDesc29 = "Write down everything you need quickly and easily with \(appName)!"
    static let shortDesc30 = "Stay organized with \(appName)!"
