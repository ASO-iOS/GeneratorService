...
struct BodyTypeCalculatorMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc21 =  "The app helps you to determine your body type."
