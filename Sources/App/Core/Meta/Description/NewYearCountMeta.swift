...
struct NewYearCountMeta: MetaProviderProtocol {
    ...
    static func getFullDesc(appName: String) -> String {
        ...
        let fullDesc13 = "\(appName) also offers various features and personalization options. You will be able to customize the \(appName) time display according to your preferences. You can choose the time format, font color and size, and add your own images or background sounds. The app also provides information about different New Year traditions and customs in different countries. You can find out how New Year's Eve is celebrated in different parts of the world and learn interesting facts about the holiday. This will help you expand your knowledge and learn more about cultural differences. \(appName) also offers a countdown feature to other holidays and events. You will be able to set a timer for any event you are interested in and keep track of how much time is left before it starts. It can be any event from birthdays to Valentine's Day."

        let fullDesc14 = "The main feature of \(appName) is its simple and intuitive interface. You will be able to easily master all the functions of the application even without prior experience with similar applications. All tools and settings are presented in a convenient and clear form, which allows you to quickly and accurately customize the application to your needs. The app also offers the ability to customize notifications and reminders for upcoming events. You will be able to receive notifications about how much time is left until New Year's Eve or other holidays, so you can always be in the know and not miss any important moments."

        let fullDesc15 = "\(appName) will help you create an unforgettable atmosphere of anticipation and joy before the New Year. With its help, you will be able to keep track of the time until the most important holiday of the year, to get in the festive mood and share this joy with your family and friends. In conclusion, \(appName) is a simple and effective app for tracking time until New Year's Eve and other holidays. It provides ample opportunities to personalize and create a festive atmosphere on your device. With its intuitive interface and a variety of features, it will be the perfect assistant for anyone who wants to create unforgettable moments before the most important holiday of the year."
    ...
    static func getShortDesc(appName: String) -> String {
        ...
        let shortDesc1 = "\(appName) - your indispensable assistant in waiting for the new year."

        let shortDesc2 = "\(appName) - create an unforgettable New Year mood with our app."

        let shortDesc3 = "\(appName) - the best way to count down the seconds until the new year."

        let shortDesc4 = "\(appName) - add magic to your New Year's Eve with our app."

        let shortDesc5 = "\(appName) - feel the magic of the new year with our app."

        let shortDesc6 = "\(appName) - your guide to the world of holiday emotions."

        let shortDesc7 = "\(appName) - let's celebrate the new year together!"

        let shortDesc8 = "\(appName) - create unforgettable moments on the eve of the new year."

        let shortDesc9 = "\(appName) - let every second of the countdown be filled with joy and anticipation."

        let shortDesc10 = "\(appName) - the most accurate and stylish countdown to the new year."

        let shortDesc11 = "\(appName) - give yourself and your loved ones unforgettable moments with our application."

        let shortDesc12 = "\(appName) - decorate your life with bright emotions and happy moments."

        let shortDesc13 = "\(appName) - let every second of countdown bring you closer to your dreams."

        let shortDesc14 = "\(appName) - create an atmosphere of magic and expectation with our app."

        let shortDesc15 = "\(appName) - let's welcome the new year with style and elegance."

        let shortDesc16 = "\(appName) - the most beautiful and interactive way to count down to the new year."

        let shortDesc17 = "\(appName) - let every second of the countdown be filled with wishes and hopes."

        let shortDesc18 = "\(appName) - create your own unique New Year atmosphere with our app."

        let shortDesc19 = "\(appName) - let every second countdown get closer to your goals and achievements."

        let shortDesc20 = "\(appName) - give yourself and your loved ones unforgettable moments of happiness and joy."
