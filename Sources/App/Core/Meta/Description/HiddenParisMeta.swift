...
struct HiddenParisMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        ...
        let shortDesc21 =  "Match dots with identical color by memorising their position."
