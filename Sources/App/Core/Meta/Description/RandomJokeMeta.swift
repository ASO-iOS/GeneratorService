...
struct RandomJokeMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc1 = "\(appName) - funny jokes on your mobile!"

        let shortDesc2 = "One-touch laughter with \(appName)!"

        let shortDesc3 = "Smile with \(appName) - the best joke app!"

        let shortDesc4 = "Never stop laughing with \(appName)!"

        let shortDesc5 = "\(appName) is your daily laughter watch!"

        let shortDesc6 = "Lift your spirits with \(appName) - the best joke app!"

        let shortDesc7 = "Jokes for every day with \(appName)!"

        let shortDesc8 = "Make your day brighter with \(appName)!"

        let shortDesc9 = "\(appName) is the best app to release tension and improve your mood!"

        let shortDesc10 = "Forget about boring moments with \(appName)!"

        let shortDesc11 = "Smile and laugh with \(appName) - your own personal comic book!"

        let shortDesc12 = "\(appName) is your daily remedy for stress and bad mood!"

        let shortDesc13 = "Enjoy moments of laughter with \(appName)!"

        let shortDesc14 = "Lighten up the atmosphere with \(appName) - the best joke app!"

        let shortDesc15 = "\(appName) is your reliable companion in search of good mood!"

        let shortDesc16 = "Smile every day with \(appName)!"

        let shortDesc17 = "Distract yourself from your daily routine with \(appName)!"

        let shortDesc18 = "\(appName) is your personal app for laughter and joy!"

        let shortDesc19 = "Everyday jokes with \(appName)!"

        let shortDesc20 = "\(appName) - your source of fun and good mood!"
