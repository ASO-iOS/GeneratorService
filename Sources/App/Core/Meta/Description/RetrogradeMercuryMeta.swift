...
struct RetrogradeMercuryMeta: MetaProviderProtocol {
    ...
    static func getFullDesc(appName: String) -> String {
        ...
        let fullDesc9 = "\(appName) is a mobile application that opens the gateway to the past and allows you to immerse yourself in the atmosphere of retro style. With its help you can create classic looks, turn your mobile experience into a true classic and unleash your retro potential. One of the main advantages of \(appName) is its ability to adapt to your working style and provide you with personalized recommendations and advice. By analyzing your preferences and behaviors, the app will offer you the best strategies to achieve your goals and increase your productivity."

        let fullDesc10 = "One of the main features of \(appName) is its time-traveling ability. You will be able to go on a fascinating journey back in time and discover new horizons. The app gives you the opportunity to go back to your roots and unlock the potential of retro fashion. \(appName) also offers a wide range of additional features to help you improve your productivity and organization. You'll be able to create notes, jot down ideas, set goals, and track your progress. You will also be able to use the project management feature, which will allow you to easily organize and control complex tasks."
        
        let fullDesc11 = "With \(appName), you can create a retro style that reflects your personality and style. The app offers a wide range of retro aesthetics so you can fulfill your wildest ideas. You'll be able to choose from different eras and styles, ranging from the 50s to the 90s, and create looks that look like they were taken straight from old photos. \(appName) is more than just an app, it's your trusted guide in the digital world. It will not only help you organize your life and work, but also help you expand your horizons and reach new heights. Thanks to its unique features, you can simplify your life, be more efficient and successful. So don't delay, download \(appName) right now and start managing your time and achieving great results!"
    ...
    static func getShortDesc(appName: String) -> String {
        ...
        let shortDesc1 = "Travel through time with \(appName)."

        let shortDesc2 = "Turn your mobile experience into a classic with \(appName)."

        let shortDesc3 = "Open new horizons with \(appName)."

        let shortDesc4 = "\(appName) is your perfect time traveling companion."

        let shortDesc5 = "Create a retro style with \(appName)."

        let shortDesc6 = "\(appName) is your gateway to the past."

        let shortDesc7 = "Immerse yourself in an old school atmosphere with \(appName)."

        let shortDesc8 = "Go back in time with \(appName)."

        let shortDesc9 = "Unleash the potential of retro fashion with \(appName)."

        let shortDesc10 = "\(appName) is your window to the past."

        let shortDesc11 = "Embody the retro aesthetic with \(appName)."

        let shortDesc12 = "Open up new possibilities with \(appName)."

        let shortDesc13 = "\(appName) is your path to retro style."

        let shortDesc14 = "Get back to your roots with \(appName)."

        let shortDesc15 = "Create classic looks with \(appName)."

        let shortDesc16 = "\(appName) is your source of inspiration from the past."

        let shortDesc17 = "Take an exciting journey through time with \(appName)."

        let shortDesc18 = "Return to the classics with \(appName)."

        let shortDesc19 = "Unleash your retro potential with \(appName)."

        let shortDesc20 = "\(appName) is your perfect partner for retro style."
