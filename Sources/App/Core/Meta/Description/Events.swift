...
struct EventsMeta {
    static let fullDesc1 = "The Calendar app is a handy tool for managing tasks and planning your time. Here you can create and keep track of various tasks, meetings, events, holidays, and plan your schedule for a week, month, or year ahead. Clear and visually appealing interface allows you to quickly and conveniently customize the application to your needs and ease of use."
    static let fullDesc2 = "The Calendar app is a reliable assistant in planning the schedule for each day. It provides the ability to create numerous events, set reminders, customize dates and times, and set up notifications so you never miss important things. The app features reminders, notifications, and synchronization with other devices, so you can always be aware of your plans and never miss important meetings and events."
    static let fullDesc3 = "The calendar has a simple and intuitive interface that is easy to use and easy to customize. Whether it's professional or personal events, the Calendar ensures that you're always on top of your schedule, ready to go, and won't forget important events in your life."
    static let fullDesc4 = "The Calendar app is a handy tool for planning and organizing your daily life. It lets you create events, set reminders, add notes, and keep track of your schedule of days. Easy to manage and customize, Calendar will help you not miss any important appointments or events."
    static let fullDesc5 = "Calendar is a mobile app that will help you manage your time and keep track of important dates and events. With its help, you will be able to create and save reminders about meetings, tasks, birthdays and other events, as well as keep track of your schedule. The application has a simple and user-friendly interface that allows you to quickly and easily create new entries in your calendar."
    ...
    static let fullDesc7 = "Calendar is a useful, super convenient app that lets you keep all your important dates and events in one place. The main features of the calendar make it stand out among similar apps. For example, you can highlight the ease of use and high speed of operation, the absence of advertising in the application."
    static let fullDesc8 = "Calendar is an effective tool for planning and organizing your time. With its user-friendly and intuitive interface, the user can create events, appointments, reminders and tasks, as well as keep track of due dates for assigned tasks and appointments."
    static let fullDesc9 = "Calendar events are displayed conveniently on the graphical interface, making it easier for the user to schedule time and not miss important appointments. Calendar provides an ideal solution for those who want to manage their time more efficiently, while getting maximum convenience and functionality from a single application."
    static let fullDesc10 = "Calendar is one of the most important applications for any device. It allows us to plan our life and time to be more organized. The Calendar app is one of the most popular calendars today, and this is no accident. With this app, you can easily and quickly create and manage your events and reminders."
