...
struct WeatherAppMeta: MetaProviderProtocol {
    ...
    static let shortDesc1 = "\(appName) - always up to date with the weather!"

    static let shortDesc2 = "Be aware of the weather with \(appName)!"

    static let shortDesc3 = "\(appName) is your reliable weather companion."

    static let shortDesc4 = "Plan your activities with \(appName)."

    static let shortDesc5 = "\(appName) is the best way to know the weather."

    static let shortDesc6 = "Be prepared for everything with \(appName)."

    static let shortDesc7 = "\(appName) - accurate and up-to-date weather information."

    static let shortDesc8 = "Weather is always at your fingertips with \(appName)."

    static let shortDesc9 = "\(appName) - your personal meteorologist."

    static let shortDesc10 = "Plan your life with \(appName)."

    static let shortDesc11 = "\(appName) - easily and conveniently find out the weather."

    static let shortDesc12 = "Be aware of the weather anywhere in the world with \(appName)."

    static let shortDesc13 = "\(appName) - your weather guide."

    static let shortDesc14 = "Weather will never surprise you with \(appName)."

    static let shortDesc15 = "\(appName) is a reliable planning assistant."

    static let shortDesc16 = "Get one-touch weather with \(appName)."

    static let shortDesc17 = "\(appName) - always know what to expect outside your window."

    static let shortDesc18 = "Stay ahead of the weather with \(appName)."

    static let shortDesc19 = "\(appName) - your real-time weather information."

    static let shortDesc20 = "Weather is in your hands with \(appName)."
