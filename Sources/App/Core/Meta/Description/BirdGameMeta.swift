...
struct BirdGameMeta: MetaProviderProtocol {
    ...
    static func getShortDesc(appName: String) -> String {
        let shortDesc1 = "Control your bird and avoid logs in \(appName), an addictive arcade game!"
        let shortDesc2 = "Control a feathered bird and avoid obstacles in \(appName)!"
        let shortDesc3 = "Control the winged one and overcome obstacles in \(appName)!"
        let shortDesc4 = " Control the feathered and fly high in the \(appName)!"
        let shortDesc5 = "Runner game in which you control a winged creature and overcome obstacles on your way!"
        let shortDesc6 = "Become a real feathery in this addictive game!"
        let shortDesc7 = "Go on an exciting feathered journe!"
        let shortDesc8 = "Only real feathered people can win!"
        let shortDesc9 = "Last as long as possible, avoiding obstacles and collecting bonuses!"
        let shortDesc10 = "A fun game that will grab your attention!"
