...
struct BirdGameMeta: MetaProviderProtocol {
    ...
    static let shortDesc1 = "Control your bird and avoid logs in \(appName), an addictive arcade game!"
    static let shortDesc2 = "Control a feathered bird and avoid obstacles in \(appName)!"
    static let shortDesc3 = "Control the winged one and overcome obstacles in \(appName)!"
    static let shortDesc4 = " Control the feathered and fly high in the \(appName)!"
