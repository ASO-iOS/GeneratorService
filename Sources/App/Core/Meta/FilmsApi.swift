...
struct FilmsAPIMeta {
    ...
    static let shortDesc1 = "Never waste time searching for a movie with Films API!"
    static let shortDesc2 = "Never miss a movie you'll love with Films API!"
    static let shortDesc3 = "Never be uncertain about your movie choices with Films API!"
    static let shortDesc4 = "Make your evening better with Films API!"
    static let shortDesc5 = "Never be afraid to choose a movie with Films API again!"
    static let shortDesc6 = "Feel like a film critic with the Films API!"
    static let shortDesc7 = "Never miss a new movie with Films API!"
    static let shortDesc8 = "Make your movie selection easier with the Films API!"
    static let shortDesc9 = "Never stop at one movie with Films API!"
    static let shortDesc10 = "Learn more about the movies you love with the Films API!"
